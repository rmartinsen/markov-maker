...
def test_conversation_json_serializable():
    conversation = create_conversation(test_corpus)
...
def test_sentence_json_serializable():
    sentence = create_sentence(test_corpus)
    json.dumps(sentence)
...
def test_person_list_json_serializable():
    person_list = create_person_list(test_names_corpora)
    json.dumps(person_list)
